...
def validate_and_classify_fees(
    ...
    *,
    ...
    Args:
        ...
        categories: Optional parallel list of fee categories. When provided,
            enables category-aware validation (amount range checks) and
            auto-approve during crawl time.

...
FEE_NAME_ALIASES: dict[str, str] = {
    ...
    "replacement atmdebit card": "card_replacement",
    ...
    "items sent for collection": "deposited_item_return",
    ...
    "deposited checks and other items returned unpaid": "deposited_item_return",
    "return item fee": "nsf",
    ...
    "loan processing fee": "loan_origination",
    "loan processing": "loan_origination",

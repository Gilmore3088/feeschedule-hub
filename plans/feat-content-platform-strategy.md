...
- [ ] Add `articles` table migration to `db.py`
- [ ] Add TypeScript types to `src/lib/crawler-db/types.ts`
- [ ] Add query functions to new `src/lib/crawler-db/articles.ts`
...
- [ ] Create `fee_crawler/generation/__init__.py`
- [ ] Create `fee_crawler/generation/article_data.py` — data query layer (5 article types)
- [ ] Create `fee_crawler/generation/templates.py` — section definitions per article type
...
- [ ] Create `fee_crawler/generation/prompts.py` — system prompt + per-section prompt builders
- [ ] Create `fee_crawler/generation/generator.py` — orchestrator: query data → build prompts → call Claude → assemble → validate
- [ ] Add fact-checking validation pass (Haiku model)
...
- [ ] Create `fee_crawler/commands/generate_articles.py`
- [ ] Register `generate-articles` in `fee_crawler/__main__.py`
- [ ] Support `--dry-run`, `--batch`, `--output-dir`, `--limit`
...
- [ ] Create `src/app/admin/articles/page.tsx` — article list
- [ ] Create `src/app/admin/articles/[id]/page.tsx` — article detail + review
- [ ] Create `src/app/admin/articles/actions.ts` — server actions (approve, reject, publish)
- [ ] Add "Articles" to admin nav
...
- [ ] Create `src/app/(public)/research/page.tsx` — article grid/list with category filters
- [ ] Create `src/app/(public)/research/[slug]/page.tsx` — article page with JSON-LD Article schema
- [ ] Add dynamic OG image for research articles (title + key stat)
- [ ] Add "Related Data" sidebar linking to relevant `/fees/[category]` pages

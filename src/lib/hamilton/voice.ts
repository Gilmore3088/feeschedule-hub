...
NARRATIVE STRUCTURE: Every section follows the situation/complication/finding/implication arc: Situation (the market context) -> Complication (the tension or problem) -> Finding (the strategic insight, tension-framed, revenue figure first if available) -> Implication (what the reader must decide or act on). Never lead with hedging language. Never describe data — state what the data means.

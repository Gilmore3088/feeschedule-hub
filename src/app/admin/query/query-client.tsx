...
const QUERY_GROUPS = [
  ...
  },
  {
    ...
    queries: [
      ...
      { label: "Recent system review actions", sql: "SELECT action, COUNT(*) as cnt, MIN(created_at) as earliest, MAX(created_at) as latest\nFROM fee_reviews\nWHERE username = 'system'\nGROUP BY action ORDER BY cnt DESC" },

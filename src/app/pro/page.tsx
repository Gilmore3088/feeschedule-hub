      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative mx-auto max-w-7xl px-6 py-16 lg:py-24">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-start">
            <div>
              <h1
                className="text-[2rem] sm:text-[2.5rem] lg:text-[3rem] leading-[1.06] tracking-[-0.03em] text-warm-900"
                style={{
              ...
              >
                ...
                <br />
                for <span className="text-terra">banking fees</span>
              </h1>
              <p className="mt-6 max-w-md text-[15px] leading-relaxed text-warm-700">
              ...
              <div className="mt-10 flex flex-wrap gap-3">
                <Link
                  ...
                  className="inline-flex items-center gap-2 rounded-md bg-terra px-5 py-2.5 text-[13px] font-semibold text-white hover:bg-terra-dark transition-colors no-underline"
                >
                  View National Index
                  <svg
                    className="h-4 w-4"
            ...
            <div className="rounded-lg border border-warm-200 bg-warm-50 overflow-hidden">
              ...
              <table className="w-full text-[12px]">
                ...
                <tbody>
                  {tickerEntries.map((entry, i) => (
                    ...
                    >
                      <td className="px-5 py-2.5 text-warm-900">
                        {getDisplayName(entry!.fee_category)}
                      </td>
                      <td className="px-3 py-2.5 text-right font-semibold text-warm-900 tabular-nums">
                        {formatAmount(entry!.median_amount)}
                      </td>
                      <td className="hidden sm:table-cell px-3 py-2.5 text-right text-warm-600 tabular-nums text-[11px]">
              ...
              <div className="px-5 py-2.5 border-t border-warm-200 flex items-center justify-between">
                ...
                <Link
                  href="/research/national-fee-index"
                  className="text-[11px] font-semibold text-terra hover:text-terra transition-colors no-underline"
                >
                  Full index
                </Link>
              </div>
        ...
        <section className="border-t border-warm-200">
          <div className="mx-auto max-w-7xl px-6 py-16 lg:py-20">
            ...
            <div className="rounded-lg border border-warm-200 overflow-hidden">
              ...
              <ul className="sm:hidden divide-y divide-warm-200">
                    ...
                    <li key={row!.category} className="px-5 py-3">
                      ...
                      <dl className="mt-1.5 grid grid-cols-3 gap-x-3 text-[11px]">
                        ...
                        <div>
                          ...
                          <dd className="font-semibold text-warm-900 tabular-nums">
                ...
                <tbody>
                  {charterComparison.map((row, i) => {
                    ...
                    return (
                      <tr
                        key={row!.category}
                        className={`hover:bg-terra-soft transition-colors ${
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {[
              ...
              <Link
                key={cap.title}
                href={cap.href}
                className={`group rounded-lg border ${cap.accent} bg-warm-50 p-5 hover:bg-warm-100 transition-all duration-300 no-underline`}
              >
                <h3
                  className="text-[13px] font-semibold text-warm-900 group-hover:text-terra transition-colors"
                  style={{
                    fontFamily: "var(--font-newsreader), Georgia, serif",
                  }}
                >
        ...
        <div className="mx-auto max-w-7xl px-6 py-16 lg:py-20">
          ...
          <div className="rounded-lg border border-warm-200 overflow-hidden">
            {/* Mobile: stacked cards (don't hide P25/P75/Min/Max; reformat).
                ...
                it visible. */}
            <ul className="md:hidden divide-y divide-warm-200">
                  ...
                  <li key={entry!.fee_category} className="px-5 py-3">
                    <div className="flex items-baseline justify-between gap-3">
                      <Link
                        ...
                        className="text-[13px] font-semibold text-warm-900 hover:text-terra transition-colors no-underline"
                      >
                        {getDisplayName(entry!.fee_category)}
                      </Link>
                      <span className="text-[15px] font-semibold text-warm-900 tabular-nums">
                        {formatAmount(entry!.median_amount)}
                      </span>
                    </div>
                ...
                {featuredEntries.map((entry, i) => (
                  ...
                  >
                    <td className="px-5 py-2.5">
                      <Link
                        href={`/fees/${entry!.fee_category}`}
                        className="text-warm-900 hover:text-terra transition-colors no-underline"
                      >
                        {getDisplayName(entry!.fee_category)}
                      </Link>
                    </td>
                    ...
                    <td className="px-3 py-2.5 text-right text-warm-600 tabular-nums">
                      {entry!.p25_amount !== null
                        ? formatAmount(entry!.p25_amount)
                        : "-"}
                    </td>
        ...
        <div className="mx-auto max-w-7xl px-6 py-16 lg:py-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 max-w-3xl">
            <div className="rounded-lg border border-warm-200 bg-warm-50 p-6">
              ...
              <Link
                href="/subscribe"
                className="mt-6 inline-flex items-center rounded border border-terra bg-terra px-4 py-2 text-[12px] font-semibold text-white hover:bg-terra-dark transition-colors no-underline"
              >
                View Plans
              </Link>
            </div>

    ...
    <>
      ...
      <div className="max-w-xl mx-auto mb-8 relative">
        <div
          className={`flex bg-white border rounded-lg overflow-hidden transition-all duration-200 ${
            status === "running" ? "border-red-700 ring-2 ring-red-100" : "border-gray-200 shadow-sm"
          }`}
        >
          <input
            ref={inputRef}
      ...
      {status === "error" && !report && (
        <div className="bg-red-50 border border-red-200 rounded-lg px-5 py-4">
          <div className="font-sans font-semibold text-[13px] text-red-700 mb-2">Analysis Error</div>
